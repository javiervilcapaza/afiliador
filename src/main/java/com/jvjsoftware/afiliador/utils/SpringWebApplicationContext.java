...
public class SpringWebApplicationContext 
{
	...
	{
		/*  Este método busca el objeto pedido dentro de los contextos de Spring.
	...
	{
		/*   Este método inicializa el contexto con archivos XML indicados
		 *   por parámetro. Esto método se usa para poder crear un contexto SPRING
		 *   desde un simple programa que tenga un main() para poder hacer ejecuciones
		 *   rápidas desde un ambiente de pruebas
		 */
		 unico = new SpringWebApplicationContext();
