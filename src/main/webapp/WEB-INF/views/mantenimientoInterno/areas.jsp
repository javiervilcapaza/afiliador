...
<script src="<c:url value="/resources/scripts/mantenimientoInterno/area.js"/>"></script>
...
<form class="stdform formBusqueda"
	action="<c:url value="/mantenimientoInterno/buscarArea"/>" method="POST" id="frmBusquedaArea">
	<p>
		<label>Nombre :</label><span class="field"> <input
			class="input-samll" name="descripcionArea" id="descripcionArea" required="required">
		</span>
	</p>
	<p class="stdformbutton">
		<button class="btn btn-primary btn-rounded" onclick="buscarArea()"><span class="icon-search icon-white"></span>  Buscar</button>
		<a class="btn btn-primary btn-rounded" onclick="limpiarArea()"><span class="icon-repeat icon-white"></span>  Limpiar</a>
	</p>
</form>
...
<p>
	<button class="btn btn-primary btn-rounded" onclick="nuevoArea()"><span class="icon-plus icon-white"></span> Nuevo</button>
</p>
