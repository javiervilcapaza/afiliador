...
<script src="<c:url value="/resources/scripts/mantenimientoInterno/bancoLista.js"/>"></script>
...
<form class="stdform formBusqueda"
	action="<c:url value="/mantenimientoInterno/buscarBanco"/>" method="POST" id="frmBusqueda">
	<p>
...
<div id="lista">
	<table class="table table-bordered" id="tabla">
		...
		<tbody>
			<c:forEach var="banco" items="${listarBancos}">
				<tr align="center">
