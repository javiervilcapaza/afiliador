...
<c:choose>
	<c:when test="${not empty listaTipoDocumentos}">
			...
			<c:forEach var="tipoDocumento" items="${listaTipoDocumentos}">
				<tr align="center">
					...
					<td width="50px" class="center">
						...
						<button class="sinEstilo" onclick="editarTipoDocumento(${tipoDocumento.id})">
					...
					<td width="50px" class="center">
						<button class="sinEstilo" onclick="eliminarTipoDocumento(${tipoDocumento.id})">
